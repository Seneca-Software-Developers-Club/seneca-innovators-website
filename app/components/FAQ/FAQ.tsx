        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            {faqs.slice(0, 4).map((faq, index) => (
              ...
              >
                ...
                <div
                  className="collapse-title flex justify-between items-center text-xl font-medium"
                  style={{ color: "#E63946" }}
                >
          ...
          <div>
            {faqs.slice(4, 8).map((faq, index) => (
              ...
              >
                <input type="checkbox" checked={expandedIndex === index + 4} readOnly />
                <div
                  className="collapse-title flex justify-between items-center text-xl font-medium"
                  style={{ color: "#E63946" }}
                >
                  ...
                  <span
                    style={{
                      color: "#E63946",
                      transition: "transform 0.3s",
                      transform: expandedIndex === index + 4 ? "rotate(180deg)" : "rotate(0deg)"
                    }}
                  >
                    &#x2193;
                  </span>
